        ...
        <>
          ...
          <div id="calculator-section" className="flex-grow py-12 md:py-20 px-4 md:px-6 relative bg-blue-50">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <div className="cloud opacity-30 cloud-1" style={{ top: '10%', left: '5%', transform: 'scale(0.8)' }}></div>
              <div className="cloud opacity-30 cloud-2" style={{ top: '30%', right: '10%', transform: 'scale(1.2)' }}></div>
              <div className="cloud opacity-30 cloud-3" style={{ top: '60%', left: '15%', transform: 'scale(0.9)' }}></div>
              <div className="cloud opacity-30 cloud-4" style={{ top: '80%', right: '8%', transform: 'scale(1.1)' }}></div>
            </div>
